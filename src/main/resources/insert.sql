--insert into users values ("qwas", true, "$2a$08$wGWlV040t3X2ZrORt681X.TOAYmDpgp5nZN1bURXblpHmSsrElUxa");
insert into users values ("qwas", true, "qwas");
insert into user_roles values (1,"USER", "qwas");
